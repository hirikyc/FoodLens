  ...
  async render() {
    return `
      <section class="upload-section">
        ...
        <button id="stopCamera" style="display: none; margin-left: 8px;">Matikan Kamera</button>
        <br /><br />
        ...
        <button id="removeImageBtn" style="display:none;margin-top:8px;">Hapus Gambar</button>
        <br />
